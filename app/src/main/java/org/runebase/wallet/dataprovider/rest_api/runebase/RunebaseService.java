package org.runebase.wallet.dataprovider.rest_api.runebase;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;

import org.runebase.wallet.model.gson.BlockChainInfo;
...
import org.runebase.wallet.model.gson.qstore.QstoreBuyResponse;
...
public class RunebaseService {

    private static RunebaseService sRunebaseService;
    private RunebaseRestService mServiceApi;

    public static RunebaseService newInstance() {
        if (sRunebaseService == null) {
            sRunebaseService = new RunebaseService();
        }
        return sRunebaseService;
    }

    private RunebaseService() {
        try {
            ...
            mServiceApi = retrofit.create(RunebaseRestService.class);
