package org.runebase.wallet.dataprovider.services.update_service;
...
import org.runebase.wallet.dataprovider.firebase.FirebaseSharedPreferences;
import org.runebase.wallet.dataprovider.firebase.listeners.FireBaseTokenRefreshListener;
...
import org.runebase.wallet.utils.BoughtContractBuilder;

import org.runebase.wallet.R;
import org.runebase.wallet.dataprovider.services.update_service.listeners.ContractPurchaseListener;
import org.runebase.wallet.dataprovider.services.update_service.listeners.TokenListener;
import org.runebase.wallet.dataprovider.services.update_service.listeners.TransactionListener;
...
import org.runebase.wallet.utils.RunebaseIntent;
...
import static org.runebase.wallet.WearListCallListenerService.ADDRESS;
import static org.runebase.wallet.WearListCallListenerService.BALANCE;
import static org.runebase.wallet.WearListCallListenerService.CURR_TIME_MILLS;
import static org.runebase.wallet.WearListCallListenerService.ITEMS;
import static org.runebase.wallet.WearListCallListenerService.UNC_BALANCE;
import static org.runebase.wallet.utils.StringUtils.convertBalanceToString;
...
public class UpdateService extends Service implements GoogleApiClient.ConnectionCallbacks {
    ...
    public void onCreate() {
        ...
        final RunebaseSharedPreference runebaseSharedPreference = RunebaseSharedPreference.getInstance();

        String balanceString = runebaseSharedPreference.getBalanceString(getApplicationContext());
        final String unconfirmedBalanceString = runebaseSharedPreference.getUnconfirmedBalanceString(getApplicationContext());
        Long lastUpdatedBalanceTime = runebaseSharedPreference.getLastUpdatedBalanceTime(getApplicationContext());
            ...
            public void call(Object... args) {
                try {
                    ...
                    try {
                        ...
                        runebaseSharedPreference.setBalanceString(getApplicationContext(), balance.toString());
                        runebaseSharedPreference.setUnconfirmedBalanceString(getApplicationContext(), unconfirmedBalance.toString());
                        runebaseSharedPreference.setLastUpdatedBalanceTime(getApplicationContext(), mLastUpdatedBalanceTime);
    ...
    private void onBalanceChange() {
        RunebaseService.newInstance().getHistoryListForSeveralAddresses(addresses, 10, 0)
    ...
    private void sendNotification(String Ticker, String Title, String Text, Uri sound) {
        ...
        notificationIntent.setAction(RunebaseIntent.OPEN_FROM_NOTIFICATION);
