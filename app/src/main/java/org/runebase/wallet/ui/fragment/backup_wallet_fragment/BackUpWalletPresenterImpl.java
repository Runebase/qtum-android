...
import org.runebase.wallet.ui.fragment.confirm_passphrase_fragment.ConfirmPassphraseFragment;
...
//                            RunebaseSharedPreference.getInstance().setKeyGeneratedInstance(getView().getContext(), true);
