...
import org.runebase.wallet.ui.fragment.token_fragment.TokenHistoryAdapter;
import org.runebase.wallet.ui.fragment.token_fragment.TokenHistoryClickListener;
import org.runebase.wallet.ui.fragment.wallet_fragment.ProgressBarHolder;
import org.runebase.wallet.ui.fragment.wallet_fragment.TransactionAdapter;
import org.runebase.wallet.ui.fragment.wallet_fragment.TransactionClickListener;
import org.runebase.wallet.ui.fragment.wallet_fragment.dark.TransactionHolderDark;
...
public class TokenHistoryAdapterDark extends TokenHistoryAdapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_TRANSACTION) {
            ...
            View view = layoutInflater.inflate(org.runebase.wallet.R.layout.item_token_transaction, parent, false);
            return new TokenHistoryHolderDark(view, listener, decimalUnits);
        } else {
            LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
            View view = layoutInflater.inflate(org.runebase.wallet.R.layout.item_progress_bar, parent, false);
