...
import org.runebase.wallet.utils.EditTextValidated;
...
public abstract class InputViewHolder extends RecyclerView.ViewHolder implements EditTextValidated.EditTextValidateListener {
    ...
    @BindView(org.runebase.wallet.R.id.til_param)
    protected
    TextInputLayout tilParam;

    @BindView(org.runebase.wallet.R.id.et_param)
    protected
    EditTextValidated etParam;

    @BindView(org.runebase.wallet.R.id.checkbox)
