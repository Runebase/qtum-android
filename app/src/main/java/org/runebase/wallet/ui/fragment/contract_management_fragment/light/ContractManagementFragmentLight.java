package org.runebase.wallet.ui.fragment.contract_management_fragment.light;
...
public class ContractManagementFragmentLight extends ContractManagementFragment {
    ...
    protected int getLayout() {
        return org.runebase.wallet.R.layout.fragment_contract_management_light;
    }

    @Override
    public void setRecyclerView(List<ContractMethod> contractMethodList, boolean needToGetValue) {
        mMethodAdapter = new MethodAdapter(contractMethodList, org.runebase.wallet.R.layout.item_contract_property_light, org.runebase.wallet.R.layout.item_contract_method_light, needToGetValue);
