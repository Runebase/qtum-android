package org.runebase.wallet.ui.fragment.store_contract.dialogs;
...
public class ConfirmPurchaseDialogFragment extends AppCompatDialogFragment {
    ...
    @BindView(org.runebase.wallet.R.id.contract_name)
    FontTextView tvContractName;

    @BindView(org.runebase.wallet.R.id.contract_type)
    FontTextView tvContractType;

    @BindView(org.runebase.wallet.R.id.price)
    FontTextView tvPrice;

    @BindView(org.runebase.wallet.R.id.miner_address)
    FontTextView tvMinerAddress;

    @OnClick(org.runebase.wallet.R.id.btn_cancel)
    public void onCancelClick() {
        dismiss();
    }

    @OnClick(org.runebase.wallet.R.id.btn_confirm)
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate((ThemeUtils.getCurrentTheme(getContext()).equals(ThemeUtils.THEME_DARK) ? org.runebase.wallet.R.layout.lyt_confirm_purchase : org.runebase.wallet.R.layout.lyt_confirm_purchase_light), container, false);
