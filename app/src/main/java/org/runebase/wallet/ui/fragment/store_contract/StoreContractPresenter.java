...
import static org.runebase.wallet.datastorage.FileStorageManager.HUMANSTANDARDTOKENUUID;
        ...
        getUnspentOutputs(new SendInteractorImpl.GetUnspentListCallBack() {
            ...
            public void onSuccess(List<UnspentOutput> unspentOutputs) {
                ...
                try {
                    ...
                    callBack.onError(getView().getContext().getString(R.string.invalid_runebase_address));
                    return;
                }
                //TODO STUB!
