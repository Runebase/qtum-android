...
import org.runebase.wallet.datastorage.TokenHistoryList;
...
public class TokenPresenterImpl extends BaseFragmentPresenterImpl implements TokenPresenter {
    ...
    private void setRunebaseAddress() {
        getView().setRunebaseAddress(getInteractor().getCurrentAddress());
    }
    ...
    private void loadAndUpdateData() {
        ...
        mSubscriptionList.add(getInteractor().getHistoryList(token.getContractAddress(), ONE_PAGE_COUNT, 0).subscribeOn(Schedulers.io())
                ...
                .subscribe(new Subscriber<TokenHistoryResponse>() {
                    ...
                    @Override
                    public void onError(Throwable e) {
//                        getView().setAlertDialog(org.runebase.wallet.R.string.no_internet_connection,
//                                org.runebase.wallet.R.string.please_check_your_network_settings,
//                                org.runebase.wallet.R.string.ok,
