...
import org.runebase.wallet.ui.fragment.wallet_fragment.WalletFragment;
...
public abstract class ReceiveFragment extends BaseFragment implements ReceiveView {
    ...
    @BindView(org.runebase.wallet.R.id.iv_qr_code)
    ...
    @BindView(org.runebase.wallet.R.id.tv_single_string)
    TextView mTextViewAddress;
    @BindView(org.runebase.wallet.R.id.bt_copy_wallet_address)
    Button mButtonCopyWalletAddress;
    @BindView(org.runebase.wallet.R.id.bt_choose_another_address)
    Button mButtonChooseAnotherAddress;
    @BindView(org.runebase.wallet.R.id.ibt_back)
    ImageButton mImageButtonBack;
    @BindView(org.runebase.wallet.R.id.rl_receive)
    RelativeLayout mRelativeLayoutBase;
    @BindView(org.runebase.wallet.R.id.cl_receive)
    protected
    CoordinatorLayout mCoordinatorLayout;

    @BindView(org.runebase.wallet.R.id.qr_progress_bar)
    ...
    @OnClick(org.runebase.wallet.R.id.iv_qr_code)
    ...
    @OnClick(org.runebase.wallet.R.id.bt_share)
    ...
    private void chooseShareMethod() {
        if (getQrCode() != null) {
            String pathofBmp = MediaStore.Images.Media.insertImage(getContext().getContentResolver(), getQrCode(), "RUNEBASE QRCode", "Share");
            ...
            getMainActivity().startActivity(Intent.createChooser(intentShareFile, "Runebase QR-Code"));
        }
    }
    ...
    @OnClick({org.runebase.wallet.R.id.bt_copy_wallet_address, org.runebase.wallet.R.id.bt_choose_another_address, org.runebase.wallet.R.id.ibt_back})
    public void onClick(View view) {
        switch (view.getId()) {
            case org.runebase.wallet.R.id.bt_copy_wallet_address:
                onCopyWalletAddressClick();
                break;
            case org.runebase.wallet.R.id.bt_choose_another_address:
    ...
    public void initializeViews() {
        ...
        setQrColors(ContextCompat.getColor(getContext(), org.runebase.wallet.R.color.colorPrimary), mCoordinatorLayout.getDrawingCacheBackgroundColor());
        ...
        mTextInputLayoutAmount.setTypeface(FontManager.getInstance().getFont(getString(org.runebase.wallet.R.string.simplonMonoRegular)));
    ...
    public void openFragmentForResult(Fragment fragment) {
        ...
        getFragmentManager()
                ...
                .add(org.runebase.wallet.R.id.fragment_container, fragment, fragment.getClass().getCanonicalName())
                .addToBackStack(null)
                .commit();
    }
    ...
    public void showToast() {
        Toast.makeText(getContext(), org.runebase.wallet.R.string.copied, Toast.LENGTH_SHORT).show();
    }
