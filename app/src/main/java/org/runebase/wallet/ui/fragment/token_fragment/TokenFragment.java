...
import org.runebase.wallet.ui.fragment.wallet_fragment.HistoryCountChangeListener;
import org.runebase.wallet.ui.fragment_factory.Factory;
import org.runebase.wallet.ui.base.base_fragment.BaseFragment;
import org.runebase.wallet.ui.fragment.token_fragment.dialogs.ShareDialogFragment;
...
public abstract class TokenFragment extends BaseFragment implements TokenView, TokenHistoryClickListener {
    ...
    private static final String runebaseAddressKey = "runebaseAddressKey";
    ...
    @Override
    public void setRunebaseAddress(String address) {
        if (!TextUtils.isEmpty(address)) {
