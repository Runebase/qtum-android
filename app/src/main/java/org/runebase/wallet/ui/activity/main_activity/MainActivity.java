...
import org.runebase.wallet.ui.activity.splash_activity.SplashActivity;
import org.runebase.wallet.ui.base.base_activity.BaseActivity;
...
import org.runebase.wallet.utils.CustomContextWrapper;
import org.runebase.wallet.utils.FontManager;

import org.runebase.wallet.ui.fragment.profile_fragment.ProfileFragment;
...
import static org.runebase.wallet.ui.base.base_fragment.BaseFragment.BACK_STACK_ROOT_TAG;
...
public class MainActivity extends BaseActivity implements MainActivityView {
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (intent != null && intent.getAction() != null) {
            switch (intent.getAction()) {
                case RunebaseIntent.OPEN_FROM_NOTIFICATION:
                    openRootWallet();
                    break;
                default:
                    break;
    ...
    public boolean checkTouchIdEnable() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (RunebaseSharedPreference.getInstance().isTouchIdEnable(getContext())) {
    ...
    public void initializeViews() {
        ...
        switch (intent.getAction()) {
            case RunebaseIntent.SEND_FROM_SDK:
                getPresenter().setSendFromIntent(true);
                mAddressForSendAction = intent.getStringExtra(RunebaseIntent.SEND_ADDRESS);
                mAmountForSendAction = intent.getStringExtra(RunebaseIntent.SEND_AMOUNT);
                mTokenAddressForSendAction = intent.getStringExtra(RunebaseIntent.SEND_TOKEN);
                break;
    ...
    protected void attachBaseContext(Context newBase) {
        super.attachBaseContext(CustomContextWrapper.wrap(newBase, RunebaseSettingSharedPreference.getInstance().getLanguage(newBase)));
    }

    public RunebaseApplication getRunebaseApplication() {
        return (RunebaseApplication) getApplication();
    }
    ...
    public Realm getRealm(){
        return ((RunebaseApplication)getApplication()).getRealm();
    }
}