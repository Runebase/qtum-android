...
import org.runebase.wallet.WearableMessagingProvider;
...
import org.runebase.wallet.dataprovider.services.update_service.WatchUpdateService;
...
public class MainActivity extends BaseActivity implements MainActivityView, WearableMessagingProvider {
        ...
        mServiceConnection = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
                if(iBinder instanceof UpdateService.UpdateBinder) {
                    RunebaseApplication.instance.setWearableMessagingProvider(MainActivity.this);
    ...
    protected void attachBaseContext(Context newBase) {
        super.attachBaseContext(CustomContextWrapper.wrap(newBase, RunebaseSharedPreference.getInstance().getLanguage(newBase)));
    }
