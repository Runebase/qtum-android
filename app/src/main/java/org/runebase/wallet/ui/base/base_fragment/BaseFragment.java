...
import org.runebase.wallet.ui.fragment.processing_dialog.ProcessingDialogFragment;
...
import org.runebase.wallet.utils.ThemeUtils;
...
public abstract class BaseFragment extends Fragment implements BaseFragmentView {
    ...
    public void setAlertDialog(String title, String message, String buttonText, PopUpType type, final AlertDialogCallBack callBack) {
        try {
            ...
            dismissAlertDialog();
            View view = LayoutInflater.from(getContext()).inflate(ThemeUtils.getCurrentTheme(getContext()).equals(ThemeUtils.THEME_DARK) ? org.runebase.wallet.R.layout.dialog_popup_fragment : org.runebase.wallet.R.layout.dialog_popup_fragment_light, null);

            FontTextView tvTitle = ((FontTextView) view.findViewById(org.runebase.wallet.R.id.tv_pop_up_title));
            tvTitle.setText(title);
            FontTextView tvMessage = ((FontTextView) view.findViewById(org.runebase.wallet.R.id.tv_pop_up_message));
            tvMessage.setText(message);
            FontButton popUpButton = ((FontButton) view.findViewById(org.runebase.wallet.R.id.bt_pop_up));
            view.findViewById(org.runebase.wallet.R.id.bt_pop_up2).setVisibility(View.GONE);

            ImageView icon = ((ImageView) view.findViewById(org.runebase.wallet.R.id.iv_icon));
            ...
            if (ThemeUtils.getCurrentTheme(getContext()).equals(ThemeUtils.THEME_DARK)) {
                switch (type.name()) {
                    case "error":
                        icon.setImageResource(org.runebase.wallet.R.drawable.ic_error);
                        view.findViewById(org.runebase.wallet.R.id.red_line).setVisibility(View.VISIBLE);
                        break;
                    case "confirm":
                        icon.setImageResource(org.runebase.wallet.R.drawable.ic_confirm);
                        view.findViewById(org.runebase.wallet.R.id.red_line).setVisibility(View.GONE);
                        break;
                }
            } else {
                switch (type.name()) {
                    case "error":
                        tvTitle.setTextColor(ContextCompat.getColor(getContext(), org.runebase.wallet.R.color.title_red_color));
                        icon.setImageResource(org.runebase.wallet.R.drawable.ic_popup_error_light);
                        break;
                    case "confirm":
                        icon.setImageResource(org.runebase.wallet.R.drawable.ic_confirmed_light);
                        break;
                }
            }
    ...
    public void setAlertDialog(String title, String message, String buttonText, String buttonText2, PopUpType type, final AlertDialogCallBack callBack) {
        try {
            ...
            tvMessage.setText(message);
            FontButton popUpButton = ((FontButton) view.findViewById(org.runebase.wallet.R.id.bt_pop_up));
            FontButton popUpButton2 = ((FontButton) view.findViewById(org.runebase.wallet.R.id.bt_pop_up2));
            view.findViewById(org.runebase.wallet.R.id.bt_pop_up2).setVisibility(View.VISIBLE);
    ...
    public void openRootFragment(Fragment fragment) {
        ...
        getFragmentManager()
                .beginTransaction()
                .replace(org.runebase.wallet.R.id.fragment_container, fragment, fragment.getClass().getCanonicalName())
