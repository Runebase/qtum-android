...
import static org.runebase.wallet.RunebaseApplication.REALM_NAME;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    final String balance = RunebaseSharedPreference.getInstance().getBalanceString(WearListCallListenerService.this);
                    final String uncBalance = RunebaseSharedPreference.getInstance().getUnconfirmedBalanceString(WearListCallListenerService.this);
                    final String address = RunebaseSharedPreference.getInstance().getCurrentAddress(WearListCallListenerService.this);
                    Gson gson = new Gson();
