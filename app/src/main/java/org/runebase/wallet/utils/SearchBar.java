...
public class SearchBar extends RelativeLayout implements View.OnClickListener{
    ...
    private void build(){
        setClickable(true);
        placeholderIcon = (ImageView) findViewById(org.runebase.wallet.R.id.icon);
        placeholderText = (TextView) findViewById(org.runebase.wallet.R.id.text);
        input = (EditText) findViewById(org.runebase.wallet.R.id.input);
        placeholder = (LinearLayout) findViewById(org.runebase.wallet.R.id.placeholder);
        cancel = (Button) findViewById(org.runebase.wallet.R.id.cancel);

        clearSearch = (ImageView) findViewById(org.runebase.wallet.R.id.bt_clear_search);
