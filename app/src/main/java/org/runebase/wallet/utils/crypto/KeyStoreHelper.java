package org.runebase.wallet.utils.crypto;
...
public class KeyStoreHelper {
    ...
    private final static String RUNEBASE_PIN_ALIAS = "runebase_alias";

    public static String getSeed(Context context, @NonNull String pin) {
        String cryptoSaltPassphrase = RunebaseSharedPreference.getInstance().getSeed(context);
